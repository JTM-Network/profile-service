...
@Service
class PluginAccessService @Autowired constructor(private val permissionService: PermissionService, @Qualifier("plugin_processor") private val processor: StripeProcessor<AccessDTO>, private val constructor: StripeEventConstructor = StripeEventConstructor()) {
